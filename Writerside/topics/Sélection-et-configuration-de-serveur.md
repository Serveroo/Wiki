# Sélection et configuration de serveur
...
#### Un écran va ensuite vous demander vos infos de payement. Pour vos projets, léquipe Serveroo vous a mis à disposition gratuitement ce service.
#### Il vous suffit de rentrer dans l'onglet **Code promo** 
#### Si vous utilisez un serveur PHP, entrez le code **PHP2024**
