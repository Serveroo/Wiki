...
L'utilisation du site est soumise aux présentes conditions d'utilisation. En naviguant sur le site, vous acceptez ces conditions d'utilisation. Si vous n'acceptez pas ces conditions d'utilisation, veuillez quitter le site.

### Propriété intellectuelle

Le présent site et l'ensemble de son contenu (notamment les textes, images, logos, vidéos, etc...) sont protégés par les lois en vigueur sur la propriété intellectuelle. Toute reproduction, représentation, adaptation, traduction, modification, distribution, commercialisation, en tout ou partie, sans l'autorisation préalable écrite de **Serveroo**, est interdite.
...
Les présentes conditions générales ont pour objet de définir les modalités et conditions d'utilisation du site de location de serveurs en ligne édité par **Serveroo**.

### Article 1 - Objet

Le site de location de serveurs en ligne proposé par **Serveroo** permet à ses utilisateurs de louer des serveurs en ligne pour leurs besoins professionnels ou personnels.
### Article 2 : Création d'un compte utilisateur

Pour pouvoir louer des serveurs, l'utilisateur doit créer un compte utilisateur en fournissant des informations personnelles exactes et complètes. L'utilisateur s'engage à ne pas utiliser de fausses identités ou des informations de contact fictives. Le compte utilisateur est personnel et ne peut pas être cédé ou transféré à des tiers.
